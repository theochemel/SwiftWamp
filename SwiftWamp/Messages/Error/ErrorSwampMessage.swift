...
class ErrorSwampMessage: SwampMessage {
    ...
    let type: SwampMessageType = .error
    let requestType: SwampMessageType
    let requestId: Int
    ...
    init(requestType: SwampMessageType, requestId: Int, details: [String: Any], error: String, args: [Any]? = nil, kwargs: [String: Any]? = nil) {
    ...
    required init(payload: [Any]) {
        self.requestType = SwampMessageType(rawValue: payload[0] as! Int)!
    ...
    func marshal() -> [Any] {
        var marshalled: [Any] = [self.type.rawValue, self.requestType.rawValue, self.requestId, self.details, self.error]
