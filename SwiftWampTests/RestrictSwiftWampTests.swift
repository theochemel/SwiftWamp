...
class RestrictSwiftWampTests: XCTestCase, SwampSessionDelegate {
    ...
    override func setUp() {
        super.setUp()
        self.transport = WebSocketSwampTransport(wsEndpoint: URL(string: self.socketUrl)!)
