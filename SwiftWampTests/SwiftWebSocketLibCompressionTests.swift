//
//  SwiftWebSocketLibCompressionTests.swift
//  SwiftWamp
//
...
class SwiftWebSocketLibCompressionTests: XCTestCase, SwampSessionDelegate {
    ...
    override func setUp() {
        super.setUp()
        let transport = SwiftWebSocketTransport(wsEndpoint: self.socketUrl, selfSignedSSL: false, compression: true)
        transport.enableDebug = true
